...
(function($) {
    ...
    if ( _mainJS ) {
        ...
        if ( document.querySelector('[data-animated-background]') ) {
            ...
            if ( (document.querySelector('[data-animated-background="effect-1"]')) || (document.querySelector('[data-animated-background="effect-2"]')) ) {
                var EasePack_js = document.createElement("script"),
                    rAF_js      = document.createElement("script");
                EasePack_js.src = 'assets/plugins/bg.animated/EasePack.min.js';
                rAF_js.src      = 'assets/plugins/bg.animated/rAF.js';
                document.body.insertBefore(EasePack_js, _mainJS);
                document.body.insertBefore(rAF_js, _mainJS);
            }
            if ( (document.querySelector('[data-animated-background="effect-3"]')) || (document.querySelector('[data-animated-background="effect-4"]')) ) {
            ...
            window.addEventListener('load', function () {
                if ( document.querySelector('[data-animated-background="effect-1"]') ) {
                    var bg_effect_1_js = document.createElement("script");
                    bg_effect_1_js.src = 'assets/plugins/bg.animated/effect-1.js';
                    document.body.insertBefore( bg_effect_1_js, _mainJS);
                } else if ( document.querySelector('[data-animated-background="effect-2"]') ) {
                    var bg_effect_2_js = document.createElement("script");
                    bg_effect_2_js.src = 'assets/plugins/bg.animated/effect-2.js';
                    document.body.insertBefore( bg_effect_2_js, _mainJS);
                }
                // deco
                else if ( document.querySelector('[data-animated-background="effect-3"]') ) {
                    var bg_effect_3_js = document.createElement("script");
                    bg_effect_3_js.src = 'assets/plugins/bg.animated/deco/effect-3.js';
                    document.body.insertBefore( bg_effect_3_js, _mainJS);
                } else if ( document.querySelector('[data-animated-background="effect-4"]') ) {
